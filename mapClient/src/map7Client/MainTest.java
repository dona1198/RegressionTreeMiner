 ...
 * Il sistema client deve collegarsi al server tramite l'indirizzo e la porta su cui il server è in ascolto.
	Indirizzo del server e porta sono acquisiti come parametri tramite args. Una volta instaurata la connessione
	l'utente può scegliere se avviare un nuovo processo di scoperta di albero di regressione o recuperare un
	albero precedentemente serializzati in un qualche file.
